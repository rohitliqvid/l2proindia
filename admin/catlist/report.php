...
?>
  ...
  <form name="searchcourse" action="waiting_documents.php" method="post">
          ...
          <div class="col-sm-12 text-right searchbg">
            <div class="search inline"> <span>Name:&nbsp;<input type="text" id='fname' name='fname' class="input-sm form-control  searchbtn" value="<?php echo $fname;?>"  style="width: 105px;"/>&nbsp;Email:&nbsp;<input type="text" id='userName' name='userName' class="input-sm form-control  searchbtn" value="<?php echo $userName;?>" style="width: 105px;" />
			 &nbsp;
...
<td class="col-xs-3 text-left" align="left"><? echo $uname; ?></td>
