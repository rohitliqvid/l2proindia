...
if (document.userInfo.fstnm.value=="")
{
alert("Please fill in the First name field!");
document.userInfo.fstnm.focus();
return false;
}
else if (document.userInfo.lstnm.value=="")
{
...
else if(document.userInfo.email.value !="" && echeck(document.userInfo.email.value) ==false)
{
...
*/
else if (document.userInfo.pwd.value!="" && (document.userInfo.pwd.value).length<6)
	{
