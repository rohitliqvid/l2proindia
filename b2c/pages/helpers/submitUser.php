...
$final_launch_url = '';
	...
	if ($totalnum2)
		...
		$a = "INSERT INTO tbl_users (firstname, lastname, username, password, userregistered, usertype, dtenrolled, email, mobile , doj, department, country, city, bank_id, sales_id, sales_code1, sales_code2, sales_code3, unique_code, business_type, business_role, client) VALUES ('$fnm','$lnm','$user_id','$password','1','$utype','$curdate','$email','$mobile','$newDOJ',$udept,100,1,'$bank_id','$sales_id','$sales_code1','$sales_code2', '$sales_code3','$unique_code','1','$business_role','5'";
		error_log($a);
		mysql_query("INSERT INTO tbl_users (firstname, lastname, username, password, userregistered, usertype, dtenrolled, email, mobile , doj, department, country, city, bank_id, sales_id, sales_code1, sales_code2, sales_code3, unique_code, business_type, business_role, client) VALUES ('$fnm','$lnm','$user_id','$password','1','$utype','$curdate','$email','$mobile','$newDOJ',$udept,$ucountry,$ucity,'$bank_id','$sales_id','$sales_code1','$sales_code2', '$sales_code3','$unique_code','$business_type','$business_role','5')") or die("2Failed Query of " . mysql_error());
		...
		if ($utype == 0 || $utype == 2)
			...
			$message = "Your login id is : $user_id and password is : $pwd Thanks";
			$mailStatus = sendMailer($user_id, $subject, $message);
			/*if($status == 'ok'){
