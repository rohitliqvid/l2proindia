...
$final_launch_url = '';
	...
	if ($totalnum2)
		...
		{
		$password = md5($pwd);
		mysql_query("INSERT INTO tbl_users (firstname, lastname, username, password, userregistered, usertype, dtenrolled, email, mobile , dob, doj, department, country, city, bank_id, sales_id, sales_code1, sales_code2, sales_code3, unique_code, business_type, business_role) VALUES ('$fnm','$lnm','$user_id','$password','1','$utype','$curdate','$email','$mobile','$newDOB','$newDOJ',$udept,$ucountry,$ucity,'$bank_id','$sales_id','$sales_code1','$sales_code2', '$sales_code3','$unique_code','$business_type','$business_role')") or die("2Failed Query of " . mysql_error());
