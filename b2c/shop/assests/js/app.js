...
function setGround() { 
	document.getElementById('content').setAttribute("style","min-height:" + $(window).height() + "px");
	
	var size = $(window).height();
	var newSize = 0.70*size;
	
document.getElementById('slimScrollDiv1').setAttribute("style","min-height:" + newSize + "px");
} 