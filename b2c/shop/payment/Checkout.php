...
file_put_contents('order.txt' , $order_num);

$merchant_id='M_viv23360_23360';         // Merchant id(also User_Id) 
$amount=$price;                  // your script should substitute the amount here in the quotes provided here
$order_id=$order_num;                    //your script should substitute the order description here in the quotes provided here
