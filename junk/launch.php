...
$launch_token = strtolower(trim($_GET['token']));
...
$result4 = mysql_query("SELECT * FROM tbl_b2client where launch_token = '$launch_token'") or die("1Failed Query of " . mysql_error());
		$i=0;
		$flag = 0;
...
<tr height="1px" bgcolor="#FFFFFF"><td colspan="3"></td></tr>
<tr height="20px"><td align="right" valign="top" class="tblWelcome WelcomeText" style="padding-right:10px;padding-left:3px" colspan="3">Welcome!&nbsp;&nbsp; |  &nbsp;&nbsp;<?echo date("F j, Y");?>&nbsp;&nbsp; <!-- |  &nbsp;&nbsp;<a onFocus='this.blur()' href="javascript:openLoginHelp();" target="_self" title="Help" class='listitems'>HELP</a--> &nbsp;&nbsp;</td><td></td></tr>
