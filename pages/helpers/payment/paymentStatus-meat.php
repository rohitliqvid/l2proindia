...
if ($paymentStatus == 0){
	...
	mysql_query("UPDATE tbl_b2c_voucher_course set status = 1 , date_brought = '$now' where voucher_id='$voucher_id' and course_id = '$bundle_id'") or die("1Failed Query of " . mysql_error());
	}
	
	include ("paymentSuccess.php");
	}else{
	echo "There was some issues in assigning course. Please contact support.";
	}
}
