...
session_start();
//session_destroy();
// include_once 'detect_device/download-app.php'; 
// <!-- older files on top -->
...
<!-- pasting older code for regestration  above this line-->


<!-- Navigation -->
<nav class="navbar navbar-default navbar-sticky navbar-scrollspy divinnav" data-minus-value-desktop="58" data-minus-value-mobile="55" data-speed="1000">
    <div class="container">
        <div class="navbar-header page-scroll " style="margin-top:0;padding:0">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navbar-menu">
                <i class="fa fa-bars"></i>
            </button>
            <a class="navbar-brand" href="index.php" style="margin-top:0 !important;padding:0;display:flex">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" id="navbar-menu" style="width:inherit;">
            <ul class="nav navbar-nav navbar-right">
                <li class=""><a href="index.php#home">Home</a></li>
                <li class=""><a href="index.php#about">About L2PRO India</a></li>
               <!-- <li class="scroll"><a href="#partners">Partners</a></li>
                <li class="scroll"><a href="#media">Media</a></li>-->
                <!--<li class="scroll"><a href="#mobileapp">Mobile App</a></li>-->
...
<section style="padding:50px 0 25px 0;">
    <div class="container" style="padding:0">
            ...
            <!-- paste here -->
            <div class="dart-headingstyle " id="keyhighlightcontent">

                <h1 class="dart-heading">Privacy Policy</h1>
                <p style="font-size:16px;">Last updated: April 01, 2024</p>
...
<h3 class="dart-heading">Interpretation and Definitions</h3>
<h5 class="dart-heading">Interpretation </h5>

<p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
&nbsp;
<h5 class="dart-heading">Definitions </h5>
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to L2PROIndia, India.</br>
...
Country refers to: Delhi, India</br>
...
Website refers to L2PRO India, accessible from https://l2proindia.com/
...
<h3 class="dart-heading">Collecting and Using Your Personal Data</h3>
<h5 class="dart-heading">Types of Data Collected</h5>
<h6 class="dart-heading">Personal Data</h6>
<p>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
Email address</br>
First name and last name</br>
Phone number</br>
&nbsp;
<h5 class="dart-heading">Usage Data</h5>
...
&nbsp;
<h5 class="dart-heading">Tracking Technologies and Cookies</h5>
We use Cookies and similar tracking technologies to track the activity on Our Service and store certain information. Tracking technologies used are beacons, tags, and scripts to collect and track information and to improve and analyze Our Service. The technologies We use may include:



                <ul class="list-style-1 " style="font-size: medium;line-height: 1.7;margin-top: 16px;">
...
<h5 class="dart-heading">Use of Your Personal Data</h5>



The Company may use Personal Data for the following purposes:</br>
<b>To provide and maintain our Service, including to monitor the usage of our Service.</b></br>
...
<ul class="list-style-1 " style="font-size: medium;line-height: 1.7;margin-top: 16px;">
                    ...
                    <li><b>With other users: </b>when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.
</li>
...
<h5 class="dart-heading">Retention of Your Personal Data</h5>
...
<h5 class="dart-heading">Transfer of Your Personal Data</h5>
...
<h5 class="dart-heading">Delete Your Personal Data</h5>
...
<h5 class="dart-heading">Disclosure of Your Personal Data</h5>

<h5 class="dart-heading">Business Transactions</h5>
...
<h5 class="dart-heading">Security of Your Personal Data</h5>
...
<h5 class="dart-heading">Children's Privacy</h5>
...
<h5 class="dart-heading">Links to Other Websites</h5>
...
<h5 class="dart-heading">Changes to this Privacy Policy</h5>
...
<h5 class="dart-heading">Contact Us</h5>

If you have any questions about this Privacy Policy, You can contact us:</br>
By email: <a href=mailto:'customercare@liqvid.com'>customercare@liqvid.com</a>
...
<?php
require_once "./footer/frontFooter.php";
?>