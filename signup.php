      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="panel-body loginpanel wrapper-x2">
         ...
         <div class="clear"></div>
          ...
          <input class="form-control input-lg width80" name = "occupation" id="LoginForm_occupation" placeholder="Occupation" type="text" maxlength="50" value="<?php echo $occupation?>"/>
		   </div> 
          
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 paddLeft0">
          <label class="control-label" for="organization">Organization </label>
          <input class="form-control input-lg width80" name = "organization" id="LoginForm_organization" placeholder="Organization" type="text" maxlength="50" value="<?php echo $organization?>"/>
		   </div> 
