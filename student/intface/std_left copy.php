...
<td width='34' class='menuTextIcon'><img src='../../graphics/Home_Btn.png' border='0' id='mIcon1' name='mIcon1'></td><td id='td1' name='td1' class="menuTextOff" onmouseover="setOverSate(this)" onclick="setState(this)" onmouseout="setOutSate(this)">Home</td>
</tr>

<tr id='mrow2'  name='mrow2' class="off" title="My Profile" onMouseOver="menuOver(this)" onMouseOut="menuOut(this);" onclick="menuClick(this,'../mydtls/mydtls.php');setPageIcon('MyDetails_Btn.png','2');">
<td width='34' class='menuTextIcon'><img src='../../graphics/MyDetails_Btn.png' border='0' id='mIcon2' name='mIcon2'></td><td id='td2' name='td2' class="menuTextOff" onmouseover="setOverSate(this)" onclick="setState(this)" onmouseout="setOutSate(this)">My Profile</td>
</tr>
...
<td width='34' class='menuTextIcon'><img src='../../graphics/Courses_Btn.png' border='0' id='mIcon3' name='mIcon3'></td><td id='td3' name='td3' class="menuTextOff" onmouseover="setOverSate(this)" onclick="setState(this)" onmouseout="setOutSate(this)">Courses</td>
</tr>
...
<td width='34' class='menuTextIcon'><img src='../../graphics/Feedback_RollOver.png' border='0' id='mIcon4' name='mIcon4'></td><td id='td4' name='td4' class="menuTextOff" onmouseover="setOverSate(this)" onclick="setState(this)" onmouseout="setOutSate(this)">Feedback</td>
</tr>
...
<td width='34' class='menuTextIcon'><img src='../../graphics/Logout_Btn.png' border='0' id='mIcon5' name='mIcon5'><td id='td5' name='td5' class="menuTextOff" onmouseover="setOverSate(this)" onclick="setState(this)" onmouseout="setOutSate(this)">Logout</td>
</tr>
