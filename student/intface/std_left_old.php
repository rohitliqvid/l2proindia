...
<td width='34' class='menuTextIcon'><img src='../../graphics/MyDetails_Btn.png' border='0' id='mIcon2' name='mIcon2'></td><td id='td2' name='td2' class="menuTextOff" onmouseover="setOverSate(this)" onclick="setState(this)" onmouseout="setOutSate(this)">My details</td>
</tr>
