...
.nav-tabs > li,nav-tabs > li > a {
    ...
    margin-bottom: -1px;border-radius: 10px 10px 0 0; background-color: #0F7236;
	}
...
.nav > li > a:hover, .nav > li > a:focus {
    ...
    background-color: #0F7236!important; border: 1px solid #054b79;
}
.table-responsive45 {
    padding-top: 10px;
  ...
  <div class="panel-body nobot panelBg" style="margin-top:20px">
        ...
        <form name="searchcourse" action="#" method="post">
          ...
          <div class="pull-right text-right searchbg">
            ...
            Search by Course Title:&nbsp;<input name="cTitle" class="input-sm form-control  searchbtn" placeholder="Search" type="text" id="cTitle" size="15" maxlength="30" value='<?=htmlspecialchars($cTitle)?>'>  &nbsp;<input name="cGroup" value='<?=htmlspecialchars($cGroup)?>' type="hidden" id="cGroup" size="15" maxlength="30" >
			...
			<section class="col-md-12 col-sm-12">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-4 col-md-4 text-left" style="padding-left: 0px;">
                    ...
                    <a class="clear" href="#">
                      <span class="h3  m-t-xs"><strong>
						
					 
					  <?php  $cGroupName;
					  if(!empty($cGroupName)){
						echo " Filing Processes in Africa:";
					  }else {
						echo "Introduction to Intellectual Property  Rights:";
					  }
	   ...
	   <section class="panel panel-default panelgridBg">
			  <div class="panel row teacher-student-wrap" style=" margin-top:20px;">
				<ul class="nav nav-tabs">
					...
					{
					?>
					<li class="active"><a data-toggle="tab" href="#basic" onclick="courseGroupSubmit('Basic');">Introduction to Intellectual Property  Rights</a></li>
					<?php
					}
					else
					{
					?>
					<li><a data-toggle="tab" href="#basic" onclick="courseGroupSubmit('Basic');">Introduction to Intellectual Property  Rights</a></li>
					<?php
					}
					?>
					...
					{
					?>
					<li class="active"><a data-toggle="tab" href="#intermediate" onclick="courseGroupSubmit('Intermediate');">Filing Processes in Africa</a></li>
					<?php
					}
					else
					{
					?>
					<li><a data-toggle="tab" href="#intermediate" onclick="courseGroupSubmit('Intermediate');">Filing Processes in Africa</a></li>
					<?php
					}
					?>
