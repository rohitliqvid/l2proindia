...
<section class="panel panel-default text-sm doc-buttons">
  <div class="panel-body nobot panelBg">
		...
		<a onFocus='this.blur()' onMouseOver='return showStatus();' href="javascript:history.go(-1);" target="_self" title="Go back" class="btn pull-right m-b-xs">Back</a>
		</div>
  </div>
...
<section class="scrollable padder mTop">
            <div class="rightContent newcourse">
              ...
              <div class="stepBg">
                <p> User ID already exists!<br><br>Please enter a different User ID.
  ...
  <div class="row-centered">
       ...
       <p> <br></br>
         Click the Back link to return, or click any of the links in the left panel to continue.</p></br>
		 <a onFocus='this.blur()' onMouseOver='return showStatus();' href="javascript:history.go(-1);" target="_self" title="Go back" class="btn btn-default">Back</a>
</div>
