...
if($_REQUEST['action'] == "get_feedback_list")
{
	...
	$query3 = "SELECT id,f_subject,f_category,f_description,f_by,f_by_id,f_date,f_status FROM tbl_feedback $searchSql ORDER BY f_date DESC";
...
<!--
<tr bgcolor="#E5E5E5"><td valign=top width='90%' class='contentBold'><?=ucfirst($F_SUBJECT)?></td><td class='content' valign=top width='10%' align='right'>&nbsp;&nbsp;&nbsp;<a onFocus='this.blur()' href="javascript:DeleteFeedback(<?=$F_ROW_ID?>)" title="Delete this feedback"><i class="fa fa-trash-o"></i></a></td><tr>
<tr bgcolor="#F1F1F3"><td valign=top colspan='2' width='100%' class='content'><?php echo $F_BY;?>, <?php echo parseDate($F_DATE)?></td><tr>
<!--<tr bgcolor="#F1F1F3"><td valign=top colspan='2' width='100%' class='content' style="text-transform: lowercase;"><?php echo $email_by;?> &nbsp;&nbsp;&nbsp;<a onFocus='this.blur()' href="mailto:<?php echo $email_by;?>" title="Reply to this feedback"><i class="fa fa-reply"></i></a></td><tr>


<tr><td valign=top colspan='2' width='100%' class='content'><?php echo ucfirst($F_DESCRIPTION)?></td><tr>
<tr><td valign=top colspan='2' width='100%' class='content'>&nbsp;</td><tr>-->
