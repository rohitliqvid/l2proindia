...
<?php
}else if(strpos($_SERVER['REQUEST_URI'], 'catlist/waiting_documents.php')!== false || strpos($_SERVER['REQUEST_URI'], 'catlist/upload_form.php') !== false) {
?>
<script>
$("#coursesActive").addClass('active');
$("#home").removeClass('active');
</script>
<?php
...
<?php
}else if(strpos($_SERVER['REQUEST_URI'], 'feedback/feedback.php')!== false || strpos($_SERVER['REQUEST_URI'], 'feedback/feedback_report.php') !== false)  {
?>
<script>
$("#feedbackActive").addClass('active');
$("#home").removeClass('active');
</script>
<?php
}else if((strpos($_SERVER['REQUEST_URI'], 'mydtls/mydtls.php')!== false) || (strpos($_SERVER['REQUEST_URI'], 'mydtls/chgpwd.php')!== false) || (strpos($_SERVER['REQUEST_URI'], 'mydtls/modify.php')!== false) || (strpos($_SERVER['REQUEST_URI'], 'mydtls/chgmsg.php')!== false) || (strpos($_SERVER['REQUEST_URI'], 'mydtls/profilemsg.php')!== false))  {
?>
<script>
