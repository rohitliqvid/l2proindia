                        ...
                        <table class="table m-b-none  table-fixed" id="results">
                            ...
                            <?php
                               $con=createConnection();
                                ...
                                //die();
								//echo "SELECT user_id FROM tbl_entry_log where user_id!='' " . $dateclause . " GROUP BY user_id  ORDER BY user_entry DESC";
...
$logindate=parseDate($user_entry);
                                ...
                                <tr>
                                    ...
                                    <td class="col-xs-5"><?php echo ucfirst(TrimString($userfullname)); ?></td> 
