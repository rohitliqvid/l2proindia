...
$query="SELECT * FROM tbl_users as A where username<>'admin' AND usertype <> 3 ".$qPart."order by A.dtenrolled DESC";

$result = mysqli_query ($con,$query); 
$num=mysqli_num_rows($result);
$output = "";
$output .= "Id, Name, Email (Username),State,Occupation,Organization,Designation,Registration Date, Status \n";
$i=0;
...
$output .= $userrowid.",".ucfirst(TrimString($userfullname)).",".obfuscate_email($uname).",".$user_state.",".$uoccupation.",".$uorganization.",".$udesignation.",".$newDT.",".$ustatus." \n";
$i++;
}
