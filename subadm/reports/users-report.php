...
<section class="panel panel-default  padder">
    ...
    <section class="panel panel-default  padder">
        ...
        <form name="deletestd" id="deletestd" onSubmit="return confirmDelete();" action="#" method="post" style="margin:0px;">
			...
			$query1 = "SELECT * FROM tbl_users as A where username<>'admin' AND usertype <> 3 " . $qPart . "order by A.dtenrolled DESC";
                        ...
                        <table class="table m-b-none dataTable table-fixed" id="results">
                            <thead class="fixedHeader">
                                <tr>
                                    ...
                                    <th  style="width: 8%;text-align: center;">Education</th>
                                    <th style="width: 7%;text-align: center;">Occupation</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="width: 18%;"><?php echo TrimString(obfuscate_email($uname)); ?></td>
                                        
                                        <td style="width: 10%;text-align: center;"><?= $user_data['user_state'] ?></td>
                                       
                                        <td style="width: 8%;text-align: center;"><?= $user_data['education'] ?></td>
                                        <td style="width: 7%;text-align: center;"><?php echo TrimString($uoccupation); ?></td>
